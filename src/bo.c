...
extern const void* dpa__u_bo_any_unique_data(const dpa_u_bo_any_unique_t*restrict const bo);
...
extern size_t dpa__u_bo_any_unique_get_size(const dpa_u_bo_any_unique_t bo);
extern dpa_u_bo_any_unique_t dpa__u_bo_intern(const dpa_u_bo_ro_t bo);
extern void dpa__u_bo_any_unique_ref(dpa_u_bo_any_unique_t ubo);
extern bool dpa__u_bo_any_unique_put(dpa_u_bo_any_unique_t ubo);
