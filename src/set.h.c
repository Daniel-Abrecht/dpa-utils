...
extern bool dpa_u_set_string_has(const dpa_u_set_string_t*restrict that, dpa_u_bo_unique_t key);
...
extern bool dpa_u_set_string_remove(dpa_u_set_string_t*restrict that, dpa_u_bo_unique_t key);
extern dpa_u_bo_unique_t dpa_u_set_string_it_fast_get_key(const dpa_u_set_string_t* that, const dpa_u_set_string_it_fast_t*const it);
extern dpa_u_bo_unique_t dpa_u_set_string_it_safe_get_key(const dpa_u_set_string_it_safe_t*const it);
extern int dpa_u_set_string_add(dpa_u_set_string_t*restrict that, dpa_u_bo_unique_t key);
