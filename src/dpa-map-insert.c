...
#define B_SET_ADD(T,U,C,P) \
  { \
    ...
    printf("dpa set\t%s\t%lf\t%lf\t%lf\n", #T, (double)result/CLOCKS_PER_SEC, (double)(result-dpa_u_total_resize_time)/CLOCKS_PER_SEC, (double)dpa_u_total_resize_time/CLOCKS_PER_SEC); \
  }
  GENERATE(B_SET_ADD)
}
