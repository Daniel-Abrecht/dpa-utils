...
int main(void){
  ...
  puts("\n# safe iterators\n");
  {
    ...
    printf("u set:");
    for(dpa_u_set_u_it_safe_t it={0}; dpa_u_set_u_it_safe_next(&myset, &it); )
      printf(" %u", dpa_u_set_u_it_safe_get_key(&it));
    puts("");

    printf("u set reversed:");
    for(dpa_u_set_u_it_safe_t it={0}; dpa_u_set_u_it_safe_prev(&myset, &it); )
      printf(" %u", dpa_u_set_u_it_safe_get_key(&it));
    puts("");

    {
      ...
      printf("u set mixed:");
      dpa_u_set_u_it_safe_next(&myset, &it);
      printf(" n:%u", dpa_u_set_u_it_safe_get_key(&it));
      dpa_u_set_u_it_safe_next(&myset, &it);
      printf(" n:%u", dpa_u_set_u_it_safe_get_key(&it));
      dpa_u_set_u_it_safe_prev(&myset, &it);
      printf(" p:%u p:eof", dpa_u_set_u_it_safe_get_key(&it));
      assert(dpa_u_set_u_it_safe_prev(&myset, &it) == false); // EOF

      dpa_u_set_u_it_safe_prev(&myset, &it);
      printf(" p:%u", dpa_u_set_u_it_safe_get_key(&it));
      dpa_u_set_u_it_safe_prev(&myset, &it);
      printf(" p:%u", dpa_u_set_u_it_safe_get_key(&it));
      dpa_u_set_u_it_safe_next(&myset, &it);
      printf(" n:%u n:eof\n", dpa_u_set_u_it_safe_get_key(&it));
      assert(dpa_u_set_u_it_safe_next(&myset, &it) == false); // EOF
    }
    ...
    for(dpa_u_set_u_it_safe_t it={0}; dpa_u_set_u_it_safe_next(&myset, &it); )
      if(i++ % 2)
        dpa_u_set_u_remove(&myset, dpa_u_set_u_it_safe_get_key(&it));
    for(dpa_u_set_u_it_safe_t it={0}; dpa_u_set_u_it_safe_next(&myset, &it); )
      printf(" %u", dpa_u_set_u_it_safe_get_key(&it));
    puts("");
  }

  {
    ...
    printf("uc set:");
    for(dpa_u_set_uc_it_safe_t it={0}; dpa_u_set_uc_it_safe_next(&myset, &it); )
      printf(" %c", dpa_u_set_uc_it_safe_get_key(&it));
    puts("");

    printf("uc set reversed:");
    for(dpa_u_set_uc_it_safe_t it={0}; dpa_u_set_uc_it_safe_prev(&myset, &it); )
      printf(" %c", dpa_u_set_uc_it_safe_get_key(&it));
    puts("");

    {
      ...
      printf("uc set mixed:");
      dpa_u_set_uc_it_safe_next(&myset, &it);
      printf(" n:%c", dpa_u_set_uc_it_safe_get_key(&it));
      dpa_u_set_uc_it_safe_next(&myset, &it);
      printf(" n:%c", dpa_u_set_uc_it_safe_get_key(&it));
      dpa_u_set_uc_it_safe_prev(&myset, &it);
      printf(" p:%c p:eof", dpa_u_set_uc_it_safe_get_key(&it));
      assert(dpa_u_set_uc_it_safe_prev(&myset, &it) == false); // EOF

      dpa_u_set_uc_it_safe_prev(&myset, &it);
      printf(" p:%c", dpa_u_set_uc_it_safe_get_key(&it));
      dpa_u_set_uc_it_safe_prev(&myset, &it);
      printf(" p:%c", dpa_u_set_uc_it_safe_get_key(&it));
      dpa_u_set_uc_it_safe_next(&myset, &it);
      printf(" n:%c n:eof\n", dpa_u_set_uc_it_safe_get_key(&it));
      assert(dpa_u_set_uc_it_safe_next(&myset, &it) == false); // EOF
    }
    ...
    for(dpa_u_set_uc_it_safe_t it={0}; dpa_u_set_uc_it_safe_next(&myset, &it); )
      if(i++ % 2)
        dpa_u_set_uc_remove(&myset, dpa_u_set_uc_it_safe_get_key(&it));
    for(dpa_u_set_uc_it_safe_t it={0}; dpa_u_set_uc_it_safe_next(&myset, &it); )
      printf(" %c", dpa_u_set_uc_it_safe_get_key(&it));
    puts("");
