...
extern dpa_u_optional_pointer_t dpa_u_map_string_get(const dpa_u_map_string_t*restrict that, dpa_u_a_bo_unique_t key);
extern dpa_u_optional_pointer_t dpa_u_map_string_get_and_remove(dpa_u_map_string_t*restrict that, dpa_u_a_bo_unique_t key);
extern int dpa_u_map_string_exchange(dpa_u_map_string_t*restrict that, dpa_u_a_bo_unique_t key, void*restrict*const value);
extern int dpa_u_map_string_set_if_unset(dpa_u_map_string_t*restrict that, dpa_u_a_bo_unique_t key, void*restrict value);
extern int dpa_u_map_string_set(dpa_u_map_string_t*restrict that, dpa_u_a_bo_unique_t key, void*restrict value);
