...
static struct lookup_result LOOKUP(
  ...
  ENTRY_HASH_TYPE psl = ((ENTRY_HASH_TYPE)i<<shift) - hash; // equivalnet to: hash & (I-1) + 1; This is because the actual PSL is 0.
  while(1){
