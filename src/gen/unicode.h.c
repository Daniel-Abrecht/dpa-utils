...
extern bool dpa_u_unicode_is_noncharacter(dpa_u_unicode_codepoint_t codepoint_);
extern enum unicode_category dpa_u_get_category_from_codepoint(dpa_u_unicode_codepoint_t codepoint);
