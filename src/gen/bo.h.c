...
extern dpa_u_bo_hashed_ro_t dpa__u_any_bo_unique__v_bo_hashed_ro_p(dpa_u_any_bo_unique_t*const bo);
...
extern dpa_u_bo_hashed_ro_t dpa__u_v_bo_hashed_ro__fixup(const dpa_u_bo_hashed_ro_t*const bo);
