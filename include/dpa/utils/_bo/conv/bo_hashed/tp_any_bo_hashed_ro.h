...
dpa_u_reproducible dpa__u_really_inline dpa__u_api inline union dpa__u_any_ro_helper dpa__u_bo_with_hash_ro__tp_any_bo_hashed_ro_1_p(union dpa__u_bo_ptr_helper*restrict bo){
  switch(bo->meta.type){
    ...
    case DPA_U_BO_REFCOUNTED_HASHED: {
      const dpa_u_bo_refcounted_hashed_ro_t*const bo_rh = bo->ptr;
      return (const union dpa__u_any_ro_helper){
        .bo_hashed = {
          .bo_simple = {
            .type = DPA_U_BO_HASHED,
            .size = dpa__u_any_bo_refcounted_hashed_ro__get_size(bo_rh),
            .data = dpa__u_any_bo_refcounted_hashed_ro__data(bo_rh),
          },
          .hash = dpa__u_any_bo_refcounted_hashed_ro__get_hash(bo_rh),
        }
      };
    }
  }
  dpa_u_unreachable("dpa_u_bo_with_hash_ro_t can't be of type %s", dpa_u_enum_get_name(dpa_u_bo_any_type, bo->meta.type));
}
#define dpa__u_bo_with_hash_ro__tp_any_bo_hashed_ro(X) ((dpa_u_any_bo_hashed_ro_t*)dpa__u_bo_any_unpack_ptr(&dpa_u_rescope(union dpa__u_any_ro_helper,dpa__u_bo_with_hash_ro__tp_any_bo_hashed_ro_1_p(dpa__u_bo_any_inline_ptr_h((X))))))
