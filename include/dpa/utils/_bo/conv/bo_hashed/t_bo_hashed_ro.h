...
#define dpa__u_bo_with_hash_ro__t_bo_hashed_ro(X) dpa_u_rescope(const dpa_u_bo_hashed_ro_t,dpa__u_bo_with_hash_ro__t_bo_hashed_ro_1_p(&dpa_u_rescope(union dpa__u_hashed_conv_helper,dpa__u_bo_with_hash_ro__t_bo_hashed_ro_2_p(X))))
#define dpa__u_bo_with_hash__t_bo_hashed_ro(X) dpa_u_rescope(const dpa_u_bo_hashed_ro_t,dpa__u_bo_with_hash__v_bo_hashed_ro_p(X))
#define dpa__u_bo_with_refcount_and_hash_ro__t_bo_hashed_ro(X) dpa__u_t_bo_hashed_ro__helper_s1(*(const dpa_u_bo_hashed_ro_t*)(X)) // FIXME
