...
#define dpa__u_bo_with_refcount_and_hash_ro__tp_any_bo_refcounted_ro(X) ((dpa_u_any_bo_refcounted_ro_t*)&dpa__u_bo_with_refcount_and_hash_ro__t_bo_refcounted_ro((X)))

#define dpa__u_bo_with_refcount_ro__tp_any_bo_refcounted_ro(X) dpa__u_bo_with_refcount_ro__tp_any_bo_refcounted_ro_2_p(&dpa_u_rescope(union dpa__u_any_ro_helper_2, dpa__u_bo_with_refcount_ro__tp_any_bo_refcounted_ro_p(X)))
...
dpa_u_reproducible dpa__u_really_inline dpa__u_api inline dpa_u_any_bo_refcounted_ro_t* dpa__u_bo_with_refcount_ro__tp_any_bo_refcounted_ro_2_p(const union dpa__u_any_ro_helper_2*const bo){
  if(bo->meta.type == DPA_U_BO_UNIQUE_HASHMAP){
    return (dpa_u_any_bo_refcounted_ro_t*)bo->bo.bo_unique_hashmap;
  }else{
    return (dpa_u_any_bo_refcounted_ro_t*)bo;
  }
}
