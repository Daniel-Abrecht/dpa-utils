...
#define dpa_u_t_bo_refcounted_ro_g(X) dpa_u_generic((X), \
    ...
    dpa_u_bo_with_refcount_ro_t*: dpa__u_bo_with_refcount_ro__t_bo_refcounted_ro(DPA__G(dpa_u_bo_with_refcount_ro_t*,(X))), \
...
#define dpa__u_bo_with_refcount__t_bo_refcounted_ro(X) dpa_u_rescope(dpa_u_bo_refcounted_ro_t,*(dpa_u_bo_refcounted_ro_t*)(X))
