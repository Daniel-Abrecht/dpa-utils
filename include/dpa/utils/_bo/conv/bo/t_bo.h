...
#define dpa__u_t_bo__helper_s1(X) (dpa_u_bo_t){ .bo_simple = dpa__u_simple_fix_type((X)) }

#define dpa__u_v_bo__t_bo(X) dpa_u_rescope(dpa_u_bo_t,X)
#define dpa__u_p_bo__t_bo(X) dpa_u_rescope(dpa_u_bo_t,*(X))
#define dpa__u_cp_bo__t_bo(X) dpa_u_rescope(dpa_u_bo_t,*(X))
...
#define dpa__u_v_bo_inline__t_bo(X) (dpa_u_bo_t){ .bo_inline = (X) }
#define dpa__u_p_bo_inline__t_bo(X) (dpa_u_bo_t){ .bo_inline = *(X) }
...
#define dpa__u_bo_with_hash__t_bo(X) dpa_u_rescope(dpa_u_bo_t,dpa__u_bo_with_hash__t_bo_p(X))
