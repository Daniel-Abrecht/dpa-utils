...
#define dpa__u_any_bo__t_bo_ro(X) dpa_u_rescope(const dpa_u_bo_ro_t,(X)->ro)
...
#define dpa__u_any_bo_ro__t_bo_ro(X) dpa_u_rescope(const dpa_u_bo_ro_t,dpa__u_any_bo_ro__v_bo_ro(X))
...
#define dpa__u_bo_gc_ro__t_bo_ro(X) dpa_u_rescope(const dpa_u_bo_ro_t,dpa__u_bo_gc_ro__v_bo_ro(X))
#define dpa__u_bo_with_hash_ro__t_bo_ro(X) dpa_u_rescope(const dpa_u_bo_ro_t,dpa__u_bo_with_hash_ro__v_bo_ro(X))
#define dpa__u_bo_with_hash__t_bo_ro(X) dpa_u_rescope(const dpa_u_bo_ro_t,dpa__u_bo_with_hash__v_bo_ro(X))
