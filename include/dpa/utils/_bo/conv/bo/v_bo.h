...
#define dpa__u_any_bo__v_bo(X) (X)

#define dpa__u_v_bo_inline__v_bo(X) _Generic(DPA__G(dpa_u_bo_inline_t,(X)).all.all, char*: *(dpa_u_bo_t*)DPA__G(dpa_u_bo_inline_t,(X)).all.all, const char*: *(const dpa_u_bo_t*)DPA__G(dpa_u_bo_inline_t,(X)).all.all)
...
#define dpa__u_v_bo_simple__v_bo(X) _Generic(DPA__G(dpa_u_bo_simple_t,(X)).all.all, char*: *(dpa_u_bo_t*)DPA__G(dpa_u_bo_simple_t,(X)).all.all, const char*: *(const dpa_u_bo_t*)DPA__G(dpa_u_bo_simple_t,(X)).all.all)
#define dpa__u_p_bo_simple__v_bo(X) (*(dpa_u_bo_t*)(X))
#define dpa__u_cp_bo_simple__v_bo(X) (*(const dpa_u_bo_t*)(X))
#define dpa__u_any_bo_simple__v_bo(X) (X)
