#ifndef DPA_U_BO_TYPES_1_H
#define DPA_U_BO_TYPES_1_H
...
static_assert(sizeof(dpa_u_a_bo_any_t)        == sizeof(uint64_t), "Unexpected padding in struct dpa_u_a_bo_any_t");
static_assert(sizeof(dpa_u_a_bo_gc_t)         == sizeof(uint64_t), "Unexpected padding in struct dpa_u_a_bo_gc_t");
static_assert(sizeof(dpa_u_a_bo_refcounted_t) == sizeof(uint64_t), "Unexpected padding in struct dpa_u_a_bo_refcounted_t");
static_assert(sizeof(dpa_u_a_bo_hashed_t)     == sizeof(uint64_t), "Unexpected padding in struct dpa_u_a_bo_hashed_t");
