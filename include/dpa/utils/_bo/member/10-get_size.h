...
dpa_u_reproducible dpa__u_really_inline dpa__u_api inline size_t dpa__u_bo_gc_ro__get_size(const dpa_u_bo_gc_ro_t*const bo){
...
dpa_u_reproducible dpa__u_really_inline dpa__u_api inline size_t dpa__u_bo_with_hash_ro__get_size(const dpa_u_bo_with_hash_ro_t*const bo){
  switch(dpa_u_bo_get_type(bo)){
    case DPA_U_BO_INLINE: return ((dpa_u_bo_inline_ro_t*)bo)->size;
...
dpa_u_reproducible dpa__u_really_inline dpa__u_api inline size_t dpa__u_bo_with_hash__get_size(const dpa_u_bo_with_hash_t*const bo){
  switch(dpa_u_bo_get_type(bo)){
    case DPA_U_BO_INLINE: return ((dpa_u_bo_inline_ro_t*)bo)->size;
...
dpa_u_unsequenced dpa__u_really_inline dpa__u_api inline size_t dpa__u_v_bo_unique__get_size(const dpa_u_bo_unique_t bo){
  switch(dpa_u_bo_get_type(bo)){
...
dpa_u_reproducible dpa__u_really_inline dpa__u_api inline size_t dpa__u_any_bo_unique__get_size(const dpa_u_any_bo_unique_t*const bo){
  switch(dpa_u_bo_get_type(bo)){
...
dpa_u_unsequenced dpa__u_really_inline dpa__u_api inline size_t dpa__u_v_bo__get_size(const dpa_u_bo_t bo){
  switch(dpa_u_bo_get_type(bo)){
    case DPA_U_BO_INLINE: return bo.bo_inline.size;
...
dpa_u_reproducible dpa__u_really_inline dpa__u_api inline size_t dpa__u_any_bo__get_size(const dpa_u_any_bo_t*const bo){
  switch(dpa_u_bo_get_type(bo)){
    case DPA_U_BO_INLINE: return ((const dpa_u_bo_inline_t*)bo)->size;
    case DPA_U_BO_HASHED:
    case DPA_U_BO_REFCOUNTED:
...
dpa_u_unsequenced dpa__u_really_inline dpa__u_api inline size_t dpa__u_v_bo_ro__get_size(const dpa_u_bo_ro_t bo){
  switch(dpa_u_bo_get_type(bo)){
    case DPA_U_BO_INLINE: return bo.bo_inline.size;
    case DPA_U_BO_SIMPLE: return bo.bo_simple.size;
    case DPA_U_BO_UNIQUE_HASHMAP: return bo.bo_unique_hashmap->bo_hashed.bo_simple.size;
...
dpa_u_reproducible dpa__u_really_inline dpa__u_api inline size_t dpa__u_any_bo_ro__get_size(const dpa_u_any_bo_ro_t*const bo){
  switch(dpa_u_bo_get_type(bo)){
    case DPA_U_BO_INLINE: return ((const dpa_u_bo_inline_t*)bo)->size;
    case DPA_U_BO_HASHED:
    case DPA_U_BO_REFCOUNTED:
