...
dpa__u_api dpa__u_really_inline inline int dpa_u_map_string_set(dpa_u_map_string_t*restrict that, dpa_u_a_bo_unique_t key, void*restrict value){
  return DPA_U_CONCAT_E(DPA__U_SM_PREFIX, _set)(&that->v, dpa_u_a_bo_unique_to_uint(key), value);
}
dpa__u_api dpa__u_really_inline inline int dpa_u_map_string_set_if_unset(dpa_u_map_string_t*restrict that, dpa_u_a_bo_unique_t key, void*restrict value){
  return DPA_U_CONCAT_E(DPA__U_SM_PREFIX, _set_if_unset)(&that->v, dpa_u_a_bo_unique_to_uint(key), value);
}
dpa__u_api dpa__u_really_inline inline int dpa_u_map_string_exchange(dpa_u_map_string_t*restrict that, dpa_u_a_bo_unique_t key, void*restrict*const value){
  return DPA_U_CONCAT_E(DPA__U_SM_PREFIX, _exchange)(&that->v, dpa_u_a_bo_unique_to_uint(key), value);
}
dpa__u_api dpa__u_really_inline inline bool dpa_u_map_string_remove(dpa_u_map_string_t*restrict that, dpa_u_a_bo_unique_t key){
  return DPA_U_CONCAT_E(DPA__U_SM_PREFIX, _remove)(&that->v, dpa_u_a_bo_unique_to_uint(key));
}
dpa__u_api dpa_u_reproducible dpa__u_really_inline inline bool dpa_u_map_string_has(const dpa_u_map_string_t*restrict that, dpa_u_a_bo_unique_t key){
  return DPA_U_CONCAT_E(DPA__U_SM_PREFIX, _has)(&that->v, dpa_u_a_bo_unique_to_uint(key));
}
...
dpa__u_api dpa_u_reproducible dpa__u_really_inline inline dpa_u_optional_pointer_t dpa_u_map_string_get(const dpa_u_map_string_t*restrict that, dpa_u_a_bo_unique_t key){
  return DPA_U_CONCAT_E(DPA__U_SM_PREFIX, _get)(&that->v, dpa_u_a_bo_unique_to_uint(key));
}
dpa__u_api dpa__u_really_inline inline dpa_u_optional_pointer_t dpa_u_map_string_get_and_remove(dpa_u_map_string_t*restrict that, dpa_u_a_bo_unique_t key){
  return DPA_U_CONCAT_E(DPA__U_SM_PREFIX, _get_and_remove)(&that->v, dpa_u_a_bo_unique_to_uint(key));
}
