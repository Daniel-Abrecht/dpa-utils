...
#define dpa_u_v_bo_refcounted_hashed_ro_g(X) dpa_u_generic((X), \
    dpa_u_bo_refcounted_hashed_ro_t: dpa__u_v_bo_refcounted_hashed_ro__v_bo_refcounted_hashed_ro(X), \
    dpa_u_bo_refcounted_hashed_ro_t*: dpa__u_p_bo_refcounted_hashed_ro__v_bo_refcounted_hashed_ro(DPA__G(dpa_u_bo_refcounted_hashed_ro_t*, (X))), \
    const dpa_u_bo_refcounted_hashed_ro_t*: dpa__u_cp_bo_refcounted_hashed_ro__v_bo_refcounted_hashed_ro(DPA__G(const dpa_u_bo_refcounted_hashed_ro_t*, (X))), \
    dpa_u_any_bo_refcounted_hashed_ro_t*: dpa__u_any_bo_refcounted_hashed_ro__v_bo_refcounted_hashed_ro(DPA__G(dpa_u_any_bo_refcounted_hashed_ro_t*, (X))) \
  )
