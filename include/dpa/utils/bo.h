...
#define dpa_u_v_bo_refcounted_g(X) dpa_u_generic((X), \
    dpa_u_bo_refcounted_t: dpa__u_v_bo_refcounted__v_bo_refcounted(X), \
    dpa_u_bo_refcounted_t*: dpa__u_p_bo_refcounted__v_bo_refcounted(DPA__G(dpa_u_bo_refcounted_t*, (X))), \
    const dpa_u_bo_refcounted_t*: dpa__u_cp_bo_refcounted__v_bo_refcounted(DPA__G(const dpa_u_bo_refcounted_t*, (X))) \
  )
